...
Note that files in `docs/plans/` and `docs/solutions/` are compound-engineering pipeline artifacts created by `/ce-plan`. They are intentional, permanent living documents ΓÇö do not recommend their removal or characterize them as unnecessary.
