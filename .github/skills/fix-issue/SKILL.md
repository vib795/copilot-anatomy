---
name: fix-issue
description: Diagnose the root cause of a bug and apply the fix. Use for failing tests, stack traces, exceptions, regressions, and "why does this break" investigations.
