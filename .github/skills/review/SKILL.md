---
name: review
description: Review code for correctness, security, performance, style, and test coverage. Use before opening a pull request, when reviewing a diff, or when checking someone else's changes.
argument-hint: "<file or diff to review>"
---

> **Recommended model:** `claude-sonnet-5` &nbsp;·&nbsp; **Agent mode:** `ask`
>
